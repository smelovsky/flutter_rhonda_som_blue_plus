...
class DeviceId extends $pb.ProtobufEnum {
  static const DeviceId DEVICE_CAMERA = DeviceId._(0, _omitEnumNames ? '' : 'DEVICE_CAMERA');
  static const DeviceId DEVICE_MOBILE = DeviceId._(65536, _omitEnumNames ? '' : 'DEVICE_MOBILE');
  static const DeviceId DEVICE_MCU = DeviceId._(262144, _omitEnumNames ? '' : 'DEVICE_MCU');

  static const $core.List<DeviceId> values = <DeviceId> [
    DEVICE_CAMERA,
    DEVICE_MOBILE,
    DEVICE_MCU,
  ];

  static final $core.Map<$core.int, DeviceId> _byValue = $pb.ProtobufEnum.initByValue(values);
  static DeviceId? valueOf($core.int value) => _byValue[value];

  const DeviceId._($core.int v, $core.String n) : super(v, n);
}
