...
class Resolution extends $pb.ProtobufEnum {
  static const Resolution RESOLUTION_12MP = Resolution._(0, _omitEnumNames ? '' : 'RESOLUTION_12MP');
  static const Resolution RESOLUTION_16MP = Resolution._(1, _omitEnumNames ? '' : 'RESOLUTION_16MP');
  ...
  const Resolution._($core.int v, $core.String n) : super(v, n);
}
