...
class Profile extends $pb.ProtobufEnum {
  static const Profile PROF_360P30 = Profile._(0, _omitEnumNames ? '' : 'PROF_360P30');
  static const Profile PROF_180P30 = Profile._(1, _omitEnumNames ? '' : 'PROF_180P30');
  static const Profile PROF_540P30 = Profile._(2, _omitEnumNames ? '' : 'PROF_540P30');
  static const Profile PROF_720P30 = Profile._(3, _omitEnumNames ? '' : 'PROF_720P30');

  static const $core.List<Profile> values = <Profile> [
    PROF_360P30,
    PROF_180P30,
    PROF_540P30,
    PROF_720P30,
  ...
  static final $core.Map<$core.int, Profile> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Profile? valueOf($core.int value) => _byValue[value];

  const Profile._($core.int v, $core.String n) : super(v, n);
}
...
class Status_StreamingStatus extends $pb.ProtobufEnum {
  static const Status_StreamingStatus STARTED = Status_StreamingStatus._(0, _omitEnumNames ? '' : 'STARTED');
  static const Status_StreamingStatus STOPPED = Status_StreamingStatus._(1, _omitEnumNames ? '' : 'STOPPED');

  static const $core.List<Status_StreamingStatus> values = <Status_StreamingStatus> [
    STARTED,
    STOPPED,
  ];

  static final $core.Map<$core.int, Status_StreamingStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Status_StreamingStatus? valueOf($core.int value) => _byValue[value];

  const Status_StreamingStatus._($core.int v, $core.String n) : super(v, n);
}
