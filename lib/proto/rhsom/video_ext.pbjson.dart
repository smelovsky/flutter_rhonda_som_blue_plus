...
const Mode$json = {
  '1': 'Mode',
  '2': [
    {'1': 'MODE_480P30_4X3', '2': 0},
    {'1': 'MODE_720P30_4X3', '2': 1},
    {'1': 'MODE_720P30', '2': 2},
    {'1': 'MODE_1080P30', '2': 3},
    {'1': 'MODE_1080P60', '2': 4},
    {'1': 'MODE_4KP30', '2': 5},
...
final $typed_data.Uint8List modeDescriptor = $convert.base64Decode(
    'CgRNb2RlEhMKD01PREVfNDgwUDMwXzRYMxAAEhMKD01PREVfNzIwUDMwXzRYMxABEg8KC01PRE'
    'VfNzIwUDMwEAISEAoMTU9ERV8xMDgwUDMwEAMSEAoMTU9ERV8xMDgwUDYwEAQSDgoKTU9ERV80'
    'S1AzMBAF');

@$core.Deprecated('Use muxerDescriptor instead')
const Muxer$json = {
  '1': 'Muxer',
  '2': [
    {'1': 'FILE', '2': 0},
...
/// Descriptor for `Muxer`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List muxerDescriptor = $convert.base64Decode(
    'CgVNdXhlchIICgRGSUxFEAASCgoGU1RSRUFNEAESBwoDVVZDEAI=');
...
final $typed_data.Uint8List codecDescriptor = $convert.base64Decode(
    'CgVDb2RlYxIICgRIMjY0EAASCAoESDI2NRABEgkKBU1KUEVHEAISCAoETlYxMhAD');
...
const Config$json = {
  '1': 'Config',
  '2': [
    {'1': 'mode', '3': 1, '4': 1, '5': 14, '6': '.CameraExt.Capture.Video.Mode', '10': 'mode'},
    {'1': 'bitrate', '3': 2, '4': 1, '5': 13, '10': 'bitrate'},
    {'1': 'codec', '3': 3, '4': 1, '5': 14, '6': '.CameraExt.Capture.Video.Codec', '10': 'codec'},
  ],
};

/// Descriptor for `Config`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List configDescriptor = $convert.base64Decode(
    'CgZDb25maWcSMQoEbW9kZRgBIAEoDjIdLkNhbWVyYUV4dC5DYXB0dXJlLlZpZGVvLk1vZGVSBG'
    '1vZGUSGAoHYml0cmF0ZRgCIAEoDVIHYml0cmF0ZRI0CgVjb2RlYxgDIAEoDjIeLkNhbWVyYUV4'
    'dC5DYXB0dXJlLlZpZGVvLkNvZGVjUgVjb2RlYw==');

@$core.Deprecated('Use setSettingsDescriptor instead')
const SetSettings$json = {
  '1': 'SetSettings',
  '2': [
    {'1': 'muxer', '3': 1, '4': 1, '5': 14, '6': '.CameraExt.Capture.Video.Muxer', '10': 'muxer'},
    {'1': 'config', '3': 2, '4': 1, '5': 11, '6': '.CameraExt.Capture.Video.Config', '10': 'config'},
  ],
...
const SetSettings_Response$json = {
  '1': 'Response',
  '2': [
    {'1': 'ret', '3': 1, '4': 1, '5': 14, '6': '.CameraExt.Capture.Video.ErrorCode', '10': 'ret'},
  ],
};
...
final $typed_data.Uint8List setSettingsDescriptor = $convert.base64Decode(
    'CgtTZXRTZXR0aW5ncxI0CgVtdXhlchgBIAEoDjIeLkNhbWVyYUV4dC5DYXB0dXJlLlZpZGVvLk'
    '11eGVyUgVtdXhlchI3CgZjb25maWcYAiABKAsyHy5DYW1lcmFFeHQuQ2FwdHVyZS5WaWRlby5D'
    'b25maWdSBmNvbmZpZxpACghSZXNwb25zZRI0CgNyZXQYASABKA4yIi5DYW1lcmFFeHQuQ2FwdH'
    'VyZS5WaWRlby5FcnJvckNvZGVSA3JldA==');
...
final $typed_data.Uint8List getSettingsDescriptor = $convert.base64Decode(
    'CgtHZXRTZXR0aW5ncxI0CgVtdXhlchgBIAEoDjIeLkNhbWVyYUV4dC5DYXB0dXJlLlZpZGVvLk'
    '11eGVyUgVtdXhlchp5CghSZXNwb25zZRI0CgNyZXQYASABKA4yIi5DYW1lcmFFeHQuQ2FwdHVy'
    'ZS5WaWRlby5FcnJvckNvZGVSA3JldBI3CgZjb25maWcYAiABKAsyHy5DYW1lcmFFeHQuQ2FwdH'
    'VyZS5WaWRlby5Db25maWdSBmNvbmZpZw==');
